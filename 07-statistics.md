...
>>
P(A|B) = probability of identical twins given that they are boy-boy twins = P(B|A)P(A)/P(B)

P(B|A) = probability of boy-boy twin given that they are identical twins

P(A) = probability of identical twin
